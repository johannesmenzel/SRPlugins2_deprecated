...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=SRChangesTest Demo Installer\n"
      else:
        line="OutputBaseFilename=SRChangesTest Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the SRChangesTest Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the SRChangesTest installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=SRChangesTest Demo installer\n"
     else:
       line="SetupWindowTitle=SRChangesTest installer\n"
