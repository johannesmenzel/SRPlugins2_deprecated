...
def main():
  ...
  plistpath = scriptpath + "/resources/SRChangesTest-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SRChangesTest-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SRChangesTest-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SRChangesTest-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SRChangesTest-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/SRChangesTest.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/SRChangesTest.iss",inplace=1):
