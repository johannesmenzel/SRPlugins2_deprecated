...
const SRParamProperties srchannelParamProperties[kNumParams] = {
  ...
  { kCompPeakRelease, cCompPeakRelease, "Peak Release", "Release", 200., 1., 2000., 0.01, 200., .5, "ms", "Compressor",IParam::EParamType::kTypeDouble, IParam::EFlags::kFlagsNone, IParam::EParamUnit::kUnitMilliseconds, SslWhite, SR::Graphics::Layout::layout.GetColor(SR::Graphics::Layout::SRCustomColors::ECustomColors::kWhite), {RectComp, 2, 11, 2.f, 2.f}, "1", "2k", "200", "Release of Peak Compressor" },
