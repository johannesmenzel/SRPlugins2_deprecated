/*
  This is the initial ios app extension view controller, which is referenced by SRChannel-iOS-MainInterface storyboard
*/

import UIKit
import CoreAudioKit

public class SRChannelViewController: AUViewController {
  ...
  func connectViewWithAU() {
    // To use the generic UI (swift), change the view in SRChannel-iOS-MainInterface.storyboard to custom class: GenericUI  module: SRChannelFramework
