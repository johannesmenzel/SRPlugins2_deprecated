...
//double magnitude;
//for (int i = 0; i < points; ++i) {
//  w = 2.0 * M_PI * (i / points)/* / samplerate*/;
//  numerator = a0 * a0 + a1 * a1 + a2 * a2 + 2.0 * (a0 * a1 + a1 * a2) * cos(w) + 2.0 * a0 * a2 * cos(2.0L * w);
//  denominator = 1.0 + b1 * b1 + b2 * b2 + 2.0 * (b1 + b1 * b2) * cos(w) + 2.0 * b2 * cos(2.0 * w);
