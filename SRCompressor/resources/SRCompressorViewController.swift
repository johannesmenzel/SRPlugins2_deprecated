/*
  This is the initial ios app extension view controller, which is referenced by SRCompressor-iOS-MainInterface storyboard
*/

import UIKit
import CoreAudioKit

public class SRCompressorViewController: AUViewController {
  ...
  func connectViewWithAU() {
    // To use the generic UI (swift), change the view in SRCompressor-iOS-MainInterface.storyboard to custom class: GenericUI  module: SRCompressorFramework
