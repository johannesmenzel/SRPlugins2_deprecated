...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=SRCompressor Demo Installer\n"
      else:
        line="OutputBaseFilename=SRCompressor Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the SRCompressor Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the SRCompressor installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=SRCompressor Demo installer\n"
     else:
       line="SetupWindowTitle=SRCompressor installer\n"
