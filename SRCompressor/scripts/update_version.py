...
def main():
  ...
  plistpath = scriptpath + "/resources/SRCompressor-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SRCompressor-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SRCompressor-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SRCompressor-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SRCompressor-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/SRCompressor.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/SRCompressor.iss",inplace=1):
