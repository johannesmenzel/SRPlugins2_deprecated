...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=SRManConvo Demo Installer\n"
      else:
        line="OutputBaseFilename=SRManConvo Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the SRManConvo Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the SRManConvo installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=SRManConvo Demo installer\n"
     else:
       line="SetupWindowTitle=SRManConvo installer\n"
