...
def main():
  ...
  plistpath = scriptpath + "/resources/SRManConvo-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SRManConvo-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SRManConvo-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SRManConvo-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SRManConvo-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/SRManConvo.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/SRManConvo.iss",inplace=1):
