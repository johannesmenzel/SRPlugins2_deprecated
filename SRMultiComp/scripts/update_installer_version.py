...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=SRMultiComp Demo Installer\n"
      else:
        line="OutputBaseFilename=SRMultiComp Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the SRMultiComp Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the SRMultiComp installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=SRMultiComp Demo installer\n"
     else:
       line="SetupWindowTitle=SRMultiComp installer\n"
