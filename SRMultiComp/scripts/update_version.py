...
def main():
  ...
  plistpath = scriptpath + "/resources/SRMultiComp-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SRMultiComp-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SRMultiComp-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SRMultiComp-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SRMultiComp-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/SRMultiComp.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/SRMultiComp.iss",inplace=1):
