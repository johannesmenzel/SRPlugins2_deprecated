/*
  This is the initial ios app extension view controller, which is referenced by SROverdrive-iOS-MainInterface storyboard
*/

import UIKit
import CoreAudioKit

public class SROverdriveViewController: AUViewController {
  ...
  func connectViewWithAU() {
    // To use the generic UI (swift), change the view in SROverdrive-iOS-MainInterface.storyboard to custom class: GenericUI  module: SROverdriveFramework
