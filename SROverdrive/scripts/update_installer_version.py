...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=SROverdrive Demo Installer\n"
      else:
        line="OutputBaseFilename=SROverdrive Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the SROverdrive Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the SROverdrive installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=SROverdrive Demo installer\n"
     else:
       line="SetupWindowTitle=SROverdrive installer\n"
