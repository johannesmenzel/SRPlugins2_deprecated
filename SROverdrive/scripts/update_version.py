...
def main():
  ...
  plistpath = scriptpath + "/resources/SROverdrive-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SROverdrive-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SROverdrive-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SROverdrive-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SROverdrive-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/SROverdrive.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/SROverdrive.iss",inplace=1):
