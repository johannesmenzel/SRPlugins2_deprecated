...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=SRPitch Demo Installer\n"
      else:
        line="OutputBaseFilename=SRPitch Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the SRPitch Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the SRPitch installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=SRPitch Demo installer\n"
     else:
       line="SetupWindowTitle=SRPitch installer\n"
