...
def main():
  ...
  plistpath = scriptpath + "/resources/SRPitch-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SRPitch-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SRPitch-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SRPitch-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SRPitch-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/SRPitch.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/SRPitch.iss",inplace=1):
