/*
  This is the initial ios app extension view controller, which is referenced by SRReverb-iOS-MainInterface storyboard
*/

import UIKit
import CoreAudioKit

public class SRReverbViewController: AUViewController {
  ...
  func connectViewWithAU() {
    // To use the generic UI (swift), change the view in SRReverb-iOS-MainInterface.storyboard to custom class: GenericUI  module: SRReverbFramework
