...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=SRReverb Demo Installer\n"
      else:
        line="OutputBaseFilename=SRReverb Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the SRReverb Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the SRReverb installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=SRReverb Demo installer\n"
     else:
       line="SetupWindowTitle=SRReverb installer\n"
