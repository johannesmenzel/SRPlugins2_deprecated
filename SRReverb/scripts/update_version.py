...
def main():
  ...
  plistpath = scriptpath + "/resources/SRReverb-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SRReverb-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SRReverb-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SRReverb-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SRReverb-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/SRReverb.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/SRReverb.iss",inplace=1):
