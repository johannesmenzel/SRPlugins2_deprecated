...
def main():
  ...
  plistpath = scriptpath + "/resources/SRReverb2-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SRReverb2-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SRReverb2-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SRReverb2-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SRReverb2-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/SRReverb2.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/SRReverb2.iss",inplace=1):
