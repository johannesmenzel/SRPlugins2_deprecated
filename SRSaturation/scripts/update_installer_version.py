...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=SRSaturation Demo Installer\n"
      else:
        line="OutputBaseFilename=SRSaturation Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the SRSaturation Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the SRSaturation installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=SRSaturation Demo installer\n"
     else:
       line="SetupWindowTitle=SRSaturation installer\n"
