...
def main():
  ...
  plistpath = scriptpath + "/resources/SRSaturation-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SRSaturation-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SRSaturation-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SRSaturation-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SRSaturation-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/SRSaturation.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/SRSaturation.iss",inplace=1):
