...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=SRSummer Demo Installer\n"
      else:
        line="OutputBaseFilename=SRSummer Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the SRSummer Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the SRSummer installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=SRSummer Demo installer\n"
     else:
       line="SetupWindowTitle=SRSummer installer\n"
