...
def main():
  ...
  plistpath = scriptpath + "/resources/SRSummer-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SRSummer-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SRSummer-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SRSummer-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SRSummer-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/SRSummer.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/SRSummer.iss",inplace=1):
