...
SRSynth::SRSynth(const InstanceInfo& info)
...
#if IPLUG_DSP
void SRSynth::ProcessBlock(sample** inputs, sample** outputs, int nFrames)
{
...
void SRSynth::OnReset()
{
  mDSP.Reset(GetSampleRate(), GetBlockSize());
}

void SRSynth::ProcessMidiMsg(const IMidiMsg& msg)
{
  TRACE;
...
void SRSynth::OnParamChange(int paramIdx)
{
  mDSP.SetParam(paramIdx, GetParam(paramIdx)->Value());
}

bool SRSynth::OnMessage(int msgTag, int ctrlTag, int dataSize, const void* pData)
{
