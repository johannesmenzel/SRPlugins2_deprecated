...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=SRSynth Demo Installer\n"
      else:
        line="OutputBaseFilename=SRSynth Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the SRSynth Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the SRSynth installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=SRSynth Demo installer\n"
     else:
       line="SetupWindowTitle=SRSynth installer\n"
