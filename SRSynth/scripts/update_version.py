...
def main():
  ...
  plistpath = scriptpath + "/resources/SRSynth-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SRSynth-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SRSynth-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SRSynth-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SRSynth-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/SRSynth.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/SRSynth.iss",inplace=1):
