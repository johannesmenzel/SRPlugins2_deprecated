...
def main():
  ...
  plistpath = scriptpath + "/resources/SRTestBed-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SRTestBed-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SRTestBed-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SRTestBed-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SRTestBed-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/SRTestBed.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/SRTestBed.iss",inplace=1):
